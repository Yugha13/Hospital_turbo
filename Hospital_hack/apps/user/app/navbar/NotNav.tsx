  ...
  return (
    <header className="flex items-center justify-between px-4 py-3 shadow-sm sm:px-6 lg:px-8">
      ...
      <nav className="hidden space-x-20 md:flex">
        <Link href="/" className="text-lg font-medium text-black   hover:text-primary" prefetch={false}>
          Home
        </Link>
      ...
      <div className="flex items-center space-x-3">
        ...
        <div className="">
          <Button variant={"secondary"} onClick={()=>navigate.push("/applyjob")}>Apply for Job</Button>
        </div>
        <LoginLink>
        ...
        <SheetContent side="right">
          <nav className="grid gap-4 p-4">
            <Link href="/" className="text-sm font-medium  text-black hover:text-primary" prefetch={false}>
              Home
            </Link>
